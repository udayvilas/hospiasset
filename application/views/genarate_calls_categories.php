            ...
            <form method="POST" name="GenerateCallForm" flex="60" flex-xs="100" class="md-whiteframe-3dp mylayout-padding" autocomplete="off">
                <div layout="row" layout-wrap flex>
                    ...
                    <div class="md-block"  flex="25">
						...
						<br>
                        <input  type="radio" ng-model="raise_call" 
						 ng-click="
                                searched.EID = null;
                                gen_call.searchEid = '';
                                gen_call.dept_id = '';
                    ...
                    <md-input-container flex="45">
                        ...
                        <md-select required ng-model="gen_call.complaint" ng-change="getCallReasons(gen_call.complaint)" name="complaint">
                            <md-option ng-repeat="call_master in call_masters" ng-value="call_master.CODE">
                                {{call_master.NAME}}
                            </md-option>
                        </md-select>
                    </md-input-container>
                    ...
                    <div layout="row">-->
                    <div flex="5" hide-xs hide-sm><!-- Space --></div>
                    <md-input-container class="md-block" flex-gt-sm flex="45" ng-hide="call_reasons==null">
                        <label>Type *</label>
                    ...
                    <div flex="5" hide-xs hide-sm ng-hide="call_reasons==null"></div>
                    <!--<md-input-container class="md-block" flex-gt-sm flex="45">
                        <label>Department</label>
                        <md-select ng-change="getDepartmentDevices(gen_call.dept_id,gen_call.branch_id)"  ng-disabled="gen_call.branch_id==null" ng-model="gen_call.dept_id" name="dept_id">
                            <md-option ng-repeat="dept in all_depts"  ng-value="dept.CODE" >
                                {{dept.USER_DEPT_NAME}} ({{dept.CODE}})
                            </md-option>
                        </md-select>
                    </md-input-container>-->
                    <!--<md-autocomplete flex="35" class="md-block" flex-gt-sm
                                     md-no-cache="false"
                                     md-selected-item="searched.Department"
                                     md-search-text="searchDepartment"
                                     md-items="item in searchTextChange(searchDepartment,'Call_Gen')"
                    ...
                    <!--<md-input-container class="md-block" flex-gt-sm flex="45">
                        ...
                        <md-select required ng-disabled="gen_call.dept_id==null"  ng-model="gen_call.device_id" name="device_id" ng-change="getDeviceDetailsByEID(gen_call.dept_id,gen_call.device_id);getEIDByPriority(gen_call.device_id);check_cms_call(gen_call.device_id)">
                            <md-option ng-repeat="device in devices"  ng-value="device.E_ID" ng-if="devices.length > 0" >
                                {{device.E_ID}}
                            </md-option>
                            <md-option ng-if="devices.length == 0"  ng-init="gen_call.sequp_model ='';gen_call.sequp_name = '';gen_call.ssrial_no='';gen_call.sphy_location='';">
                                No Equipments Found
                            </md-option>
                        </md-select>
                        <span ng-bind="CMessage" ng-style="{color:CColor}"></span>
                    </md-input-container>-->
                    <md-autocomplete  ng-if="raise_call == 'EID' && gen_call.branch_id != NULL" class="md-block" flex-gt-sm flex="35"
                    ...
                    <div flex="5" hide-xs hide-sm ><!-- Space --></div >
                    <md-autocomplete  ng-if="raise_call == 'SR' && gen_call.branch_id != NULL" class="md-block" flex-gt-sm flex="35"
                                      md-no-cache="true"
                                      md-selected-item="searched.sno"
                                      md-search-text="gen_call.searchSerialno"
                                      md-items="item in searchTextChangeOne(gen_call.searchSerialno,gen_call.branch_id)"
                    ...
                    <md-input-container class="md-block" ng-if="raise_call == 'SR'" flex-gt-sm flex="45">
                        <label>Equipment ID</label>
