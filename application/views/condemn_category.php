                ...
                <div layout="row" layout-wrap flex>
                    ...
                    <md-input-container flex="45">
                        ...
                        <md-select required ng-model="gen_call.complaint" ng-change="getCallReasons(gen_call.complaint)" name="complaint">
                            <md-option ng-repeat="call_master in call_masters" ng-if="call_master.CODE =='CN'" ng-value="call_master.CODE">
                                {{call_master.NAME}}
                            </md-option>
                        </md-select>
                    ...
                    <md-input-container ng-if="gen_call.type==transfers[0]" class="md-block" flex-gt-sm flex="45">
                        ...
                        <div ng-messages="GenerateCallForm.roleid.$error">
                            <div ng-message="required">Required.</div>
                        </div>
                    </md-input-container>
                    ...
                    <md-input-container class="md-block" flex-gt-sm  flex="45" ng-if="gen_call.complaint==nature_of_calls[3]">
                        <label>Reasons*</label>
                        <md-select required ng-model="gen_call.condem_reasons" name="reasons" multiple>
                            <md-option ng-repeat="conreason in conreasons"  ng-value="conreason.CODE">
                                {{conreason.REQUEST_NAME}} ({{conreason.CODE}})
                            </md-option>
                        </md-select>
						<div ng-messages="GenerateCallForm.condem_reasons.$error">
                            <div ng-message="required">Required.</div>
                        </div>
                    </md-input-container>
