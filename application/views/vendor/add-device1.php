    ...
    <div layout="column">
        ...
        <div class="md-whiteframe-2dp mylayout-padding" style="border-radius:5px;">
            <form name="AddDevice" method="POST">
                ...
                <div layout-gt-sm="row" layout-xs="column" layout-gt-xs="column" layout="row" layout-wrap>
                    <md-input-container ng-if="user_general_asset==yesstate" class="md-block" flex-gt-sm flex="15">
                ...
                <div layout-gt-sm="row" layout-xs="column" layout-gt-xs="column" layout="row">-->
                    ...
                    <div flex="5" hide-xs hide-sm><!-- Space -->
                    <md-input-container class="md-block" flex-gt-sm flex="20">
                    ...
                    <!---<mdp-date-picker md-required="true"  mdp-placeholder="Date of Install *" name="date_of_install" required class="md-block" flex-gt-sm flex="20" mdp-format="DD-MM-YYYY" ng-model="add_device.date_of_install">
                    </mdp-date-picker>--->
                    <div flex="5" hide-xs hide-sm><!-- Space --></div>
                    <md-input-container class="md-block" flex-gt-sm flex="20">
                        <label>Manufacture Date(MM-YYYY)</label>
                        <input required type="text" ng-pattern="/^([0-9]{2})-([0-9]{4})$/"  ng-model="add_device.manufacture_date" name="manufacture_date" aria-label="manufacture_date"/>
                    ...
                    <md-input-container class="md-block" flex-gt-sm flex="20">
                        ...
                        <input type="text" ng-pattern="/^([0-9]{2})-([0-9]{4})$/" ng-model="add_device.end_of_life" name="end_of_life" aria-label="end_of_life"/>
