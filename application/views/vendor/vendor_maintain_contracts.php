...
<md-content class="mylayout-padding" md-theme="hospiclr">
    <div layout="column">
        ...
        <div layout="row" layout-align="space-around center" style="border-bottom:1px solid #DDD;margin-bottom: 8px;" class="reveal-animation">
            <!--<div ng-click="loadMaintanceContracts(0,null)" flex="10" class="widget margin-4" style="background-color:#283593;cursor: pointer;" layout="column">
                <div class="card-margin-4" layout-align="center center" layout="row">
                    <span class="fff-color">{{m_contracts_cnt[0]}}</span>
                </div>
                <div flex layout="row" layout-align="center center">
                    <span class="fff-color">All</span>
                </div>
            </div>-->
        ...
        <div layout-gt-sm="row" layout-xs="column" layout-gt-xs="column" layout="row" layout-align="center center">
            <mdp-date-picker mdp-placeholder="Contract Expiry From" class="md-block" flex-gt-sm flex="15" mdp-format="DD-MM-YYYY" ng-model="mcontract.fromdate">
            </mdp-date-picker>
            <div flex="5" hide-xs hide-sm><!-- Space --></div>
            <mdp-date-picker mdp-disabled="mcontract.fromdate==''" mdp-placeholder="Contract Expiry To" class="md-block" flex-gt-sm flex="15" mdp-format="DD-MM-YYYY" ng-model="mcontract.todate" mdp-min-date="mcontract.fromdate" >
            </mdp-date-picker>
            <div flex="5" hide-xs hide-sm><!-- Space --></div>
            <!--<md-input-container class="md-block" flex-gt-sm flex="15">
                <label>Expiry Within *</label>
                <md-select ng-model="mcontract.expiry_in" name="expiry_in" aria-label="expiry_in">
                    <md-option ng-value="nullValue">
                        Select
                    </md-option>
                    <md-option ng-repeat="expire in expires" ng-value="expire.code">
                        {{expire.value}}
                    </md-option>
                </md-select>
            </md-input-container>-->
            <md-autocomplete flex="20" class="md-block" flex-gt-sm
                             ...
                             md-items="item in searchTextChange(searchVname,'vendor')"
            ...
            <div flex="1" hide-xs hide-sm flex="15"><!-- Space --></div>
        ...
        <div layout="row" layout-md="row" flex-gt-sm="row" layout-xs="column">
            <div layout="column">
                <md-button ng-if="can_add_contract==yesstate" ui-sref="home.add_maintain_contracts" class="md-raised md-primary">Add New</md-button>
            </div>
            <div layout="column">
                <md-button ng-if="can_add_contract==yesstate" ui-sref="home.add_multiple_contracts" class="md-raised md-primary">Add Multiple</md-button>
            </div>
        </div>
        <div layout="row" flex>
            <table class="md-api-table table table-bordered">
                ...
                <tr ng-if="m_contracts!=null && m_contracts!='undefined'" ng-repeat="m_contract in m_contracts">
                    ...
                    <td style="text-align: center;">
                        ...
                        <button ng-if="can_renew_contract==yesstate" ng-click="editRenuvalType($event,m_contract)" class="btn btn-xs btn-default" aria-label="Edit">
