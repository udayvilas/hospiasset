...
<md-content class="mylayout-padding" ng-cloak>
    <div layout="column">
       <!-- <div ng-include="'includes/call_alerts'"></div>--->
        ...
        <div layout-gt-sm="row" layout-xs="column" layout-gt-xs="column" layout="row" flex>
            <!--
             ...
             <div flex="5" ng-show="user_role_code==HMADMIN" hide-xs hide-sm><!-- Space --</div>
             <md-input-container ng-show="user_role_code==HMADMIN" class="no-margin-padding-md-input" flex="10" flex-xs="100">
                 <md-select placeholder="Select" ng-model="admin_call_selected" ng-change="myCallsAdmin(admin_call_selected)" aria-label="admin">
                     <md-option ng-value="admin_call_select" ng-repeat="admin_call_select in admin_calls_select">{{admin_call_select}}</md-option>
                 </md-select>
             </md-input-container>
             -->

            <md-input-container ng-show="user_role_code==HBHOD" class="no-margin-padding-md-input" flex="10" flex-xs="100">
                <md-select placeholder="Select" ng-model="hod_call_selected" ng-change="myCallsHod(hod_call_selected)" aria-label="hod">
                    <md-option ng-value="hod_call_select" ng-repeat="hod_call_select in hod_calls_select">{{hod_call_select}}</md-option>
                </md-select>
            </md-input-container>
        </div>
            ...
            <table class="md-api-table table table-bordered" ng-cloak>
                ...
                <tr ng-if="(trnsfer.TRANSFER_BRANCH==user_branch || trnsfer.TRANSFER_STATUS==transfers_status[0] || user_role_code==HMADMIN) && (trnsfer.BRANCH_ID==null || trnsfer.TRANSFER_BRANCH==user_branch || trnsfer.BRANCH_ID==user_branch || user_role_code==HMADMIN)" ng-repeat="trnsfer in pending_trnsfers">
                    ...
                    <td style="width: 8%;text-align:center;">
                        ...
                        <div ng-else>
                            <div ng-hide="user_role_code==VENDOR">
                ...
                <tr ng-repeat="condemination in condeminations">
                    ...
                    <td style="width:8%;">
                        <div style="text-align:center;" ng-if="condemination.CONDEMNATION_STATUS==null">
                            <button ng-disabled="can_approve_condemnation!=yesstate && isUserNotApproved(condemination.APPROVED_BY)" class="btn btn-xs btn-default" ng-click="EditAdminCondemination($event,condemination)" aria-label="Conduct Button{{$index}}">
                    ...
                    <td style="width: 6%;">
                        <div style="text-align: center">
                            <button ng-if="condemination.CONDEMNATION_STATUS=='Approved' && fromJsonLength(condemination.APPROVED_BY)==condem_approvals_count && can_close_condemnation==yesstate" ng-disabled="condemination.RESOLD_VALUE!=null" class="btn btn-xs btn-default" ng-click="EditApprovedCondemnation($event,condemination)" aria-label="Conduct Button{{$index}}">
