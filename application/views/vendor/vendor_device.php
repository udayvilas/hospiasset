        ...
        <div>
            <form name="Search" method="post">
                <div flex layout-gt-sm="row"  layout="row">
                    ...
                    <md-button class="md-button md-raised md-accent" aria-label="download" ng-click="excelReport(depart_devices)"  >
                        Excel Export
                    </md-button>
                    <div flex="10" ng-show="user_role_code!=HMADMIN" hide-xs hide-sm></div>
                    <md-button ng-show="user_role_code!=HMADMIN" class="md-button md-raised md-accent" aria-label="download" href="<?php echo base_url('reports/download_devices'); ?>" target="_blank">
                        Download Eq's Pdf
                    </md-button>
                </div>
            </form>
            ...
            <table class="md-api-table table table-bordered" style="width:100%;">
                ...
                <tr ng-repeat="depart_device in depart_devices">
                    ...
                    <td style="width:10%;text-align: center;">
                        <button ng-if="can_update_equp==yesstate" ng-click="editEquipment($event,depart_device)" class="btn btn-xs btn-default" aria-label="Edit">
                            <md-tooltip md-direction="top">Edit</md-tooltip>
                            <md-icon class="material-icons-new" style="color: #614da4;">mode_edit</md-icon>
                        </button>
                        <button ng-click="viewEquipmentDetails($event,depart_device)" class="btn btn-xs btn-default" aria-label="View">
                            <md-tooltip md-direction="top">View</md-tooltip>
                            <md-icon class="material-icons-new" style="color: rgb(68,138,255);">launch</md-icon>
                        </button>
                        <button ng-click="EquipmentReplacement($event,depart_device)" class="btn btn-xs btn-default" aria-label="Replace">
