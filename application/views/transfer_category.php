                ...
                <div layout="row" layout-wrap flex>
                    ...
                    <md-input-container flex="45">
                        ...
                        <md-select required ng-model="gen_call.complaint" ng-change="getCallReasons(gen_call.complaint)" name="complaint">
                            <md-option ng-repeat="call_master in call_masters" ng-if="call_master.CODE =='TR'" ng-value="call_master.CODE">
                                {{call_master.NAME}}
                            </md-option>
                        </md-select>
                    ...
                    <md-input-container class="md-block" flex-gt-sm flex="45">
                        ...
                        <md-select ng-model="gen_call.type" name="type">
                            <md-option required ng-repeat="call_reason in call_reasons" required ng-value="call_reason.CODE">
                    ...
                    <div flex="5" hide-xs hide-sm><!-- Space --></div>
                    <md-autocomplete  ng-if="raise_call == 'EID'"  class="md-block" flex-gt-sm flex="35"
                    ...
                    <div flex="5" hide-xs hide-sm><!-- Space --></div>
                    <md-autocomplete  ng-if="raise_call == 'SR'"  class="md-block" flex-gt-sm flex="35"
                                      md-no-cache="false"
                    ...
                    <div ng-messages="GenerateCallForm.sphy_location.$error">
                            <div ng-message="required">Required.</div>
                        </div>
					</md-input-container>
                    <div flex="5" hide-xs hide-sm ><!-- Space --></div>
                    <md-input-container class="md-block" flex-gt-sm flex="45" ng-if="gen_call.type==transfers[0]">
                        ...
                        <div ng-messages="GenerateCallForm.plocation.$error">
                            <div ng-message="required">Required.</div>
                        </div>
                    </md-input-container>
                    ...
                    <md-input-container ng-if="gen_call.type==transfers[1]" class="md-block" flex-gt-sm flex="45">
                        ...
                        <md-select  required ng-required="gen_call.type==transfers[1]" ng-model="gen_call.ttype" name="ttype">
                            <md-option ng-repeat="transfer_type in transfer_types"  ng-value="transfer_type">
                                {{transfer_type}}
                            </md-option>
                        </md-select>
						<div ng-messages="GenerateCallForm.ttype.$error">
                            <div ng-message="required">Required.</div>
                        </div>
                    </md-input-container>
                    <!--</div>-->
                    ...
                    <md-input-container ng-if="gen_call.type==transfers[0]" class="md-block" flex-gt-sm flex="45">
                        ...
                        <div ng-messages="GenerateCallForm.newdepts.$error">
                            <div ng-message="required">Required.</div>
                        </div>
                    </md-input-container>
