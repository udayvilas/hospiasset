                ...
                <div layout="column" layout-wrap flex>
                    ...
                    <div flex layout="row">
                        ...
                        <md-input-container class="md-block" flex-gt-sm flex="45">
                            ...
                            <input type="text"  ng-model="edit_ocp.cp_designation" name="cp_designation" aria-label="cp_designation"/>
                        </md-input-container>>
                    </div>
                    <div flex layout="row" layout-align="center center">
                        <center>
                            <md-button class="md-raised md-accent" ng-click="UpdateAptOCP(edit_ocp)" ng-disabled="OCPForm.$invalid" aria-label="submit">Update</md-button>
                        </center>
                    </div>
                </div>
            </form>
