...
<div layout="row" layout-md="row" flex-gt-sm="row" layout-xs="column" class="widget-container">
	<div ui-sref="home.{{user_role_code | lowercase}}_today_calls"  flex="10" flex-xs="100" flex-gt-sm="66" layout-xs="row" class="widget margin-4" style="background-color:#007e7a;" layout="column">
		<div class="card-margin-4" layout-align="space-between start" layout="row">
			<md-icon flex="20" layout-align="start none" md-svg-src="assets/svgs/trainings.svg" aria-label="training"></md-icon>
			<div flex="70"></div>
			<div flex="10" layout-align="end" style="color:#fff;">{{call_counts.tickets_cnt}}</div>
		</div>
		<div flex layout="row" layout-align="center center">
			<span style="color:#FFF;">Today Calls</span>
		</div>
	</div>
	<div ui-sref="home.{{user_role_code | lowercase}}_today_calls" flex="10" flex-xs="100" flex-gt-sm="66" layout-xs="row"  class="widget margin-4"  style="background-color:#00b9ee;" layout="column">
	...
	<div ui-sref="home.{{user_role_code | lowercase}}_responded_calls" flex="10" flex-xs="100" flex-gt-sm="66" layout-xs="row" class="widget margin-4"  style="background-color:#f03f35;" layout="column">
	...
	<div ui-sref="home.{{user_role_code | lowercase}}_pending_qcs" flex="10" flex-xs="100" flex-gt-sm="66" layout-xs="row" class="widget margin-4"  style="background-color:#0065a3;" layout="column">
	  <div flex class="card-margin-4" layout="row">
	...
	<div ui-sref="home.{{user_role_code | lowercase}}_today_calls" flex="10" flex-xs="100" flex-gt-sm="66" layout-xs="row" class="widget margin-4"  style="background-color:#c3a303;" layout="column">
	  <div flex class="card-margin-4" layout="row">
	  ...
	  <div flex layout="row" layout-align="center center">
		<span style="color:#FFF;">Adverse Incidents</span>
	  </div>
	</div>

	<div ui-sref="home.{{user_role_code | lowercase}}_today_calls" flex="10" flex-xs="100" flex-gt-sm="66" layout-xs="row" class="widget margin-4" style="background-color:#f25b22;" layout="column">
	  <div flex class="card-margin-4" layout="row">
	...
	<div ui-sref="home.{{user_role_code | lowercase}}_today_calls" flex="10" flex-xs="100" flex-gt-sm="66" layout-xs="row" class="widget margin-4" style="background-color:#2b247d;" layout="column">
		<div flex class="card-margin-4" layout="row">
	...
	<div ui-sref="home.{{user_role_code | lowercase}}_today_calls" flex="10" flex-xs="100" flex-gt-sm="66" layout-xs="row" class="widget margin-4" style="background-color:#09ace8;" layout="column">
		<div flex class="card-margin-4" layout="row">
