...
<div layout="row" layout-md="row" flex-gt-sm="row" layout-xs="column" class="widget-container">
	...
	<div ui-sref="home1.{{user_role_code | lowercase}}_today_calls" flex="10" flex-xs="100" flex-gt-sm="66" layout-xs="row" class="widget margin-4"  style="background-color:#007e7a;" layout="column">
	...
	<div ui-sref="home1.open_calls" flex="10" flex-xs="100" flex-gt-sm="66" layout-xs="row"  class="widget margin-4"  style="background-color:#00b9ee;" layout="column">
	...
	<div ui-sref="home1.{{user_role_code | lowercase}}_responded_calls" flex="10" flex-xs="100" flex-gt-sm="66" layout-xs="row" class="widget margin-4" style="background-color:#353bf0;" layout="column">
		<div flex class="card-margin-4" layout="row" layout-align="center center">
	...
	<div ui-sref="home1.{{user_role_code | lowercase}}_attended_calls" flex="10" flex-xs="100" flex-gt-sm="66" layout-xs="row" class="widget margin-4"  style="background-color:#f58f20;" layout="column">
		<div flex class="card-margin-4" layout="row">
	...
	<div ui-sref="home1.{{user_role_code | lowercase}}_propen_calls" flex="10" flex-xs="100" flex-gt-sm="66" layout-xs="row" class="widget margin-4"  style="background-color:#ffc425;" layout="column">
		<div flex class="card-margin-4" layout="row">
	...
	<div ui-sref="home1.{{user_role_code | lowercase}}_pending_pms" flex="10" flex-xs="100" flex-gt-sm="66" layout-xs="row" class="widget margin-4"  style="background-color:#cbb778;" layout="column">
		<div flex class="card-margin-4" layout="row">
	...
	<div ui-sref="home1.{{user_role_code | lowercase}}_pending_qcs" flex="10" flex-xs="100" flex-gt-sm="66" layout-xs="row" class="widget margin-4"  style="background-color:#2989c3;" layout="column">
		<div flex class="card-margin-4" layout="row">
	...
	<div ui-sref="home1.adverse_calls" flex="10" flex-xs="100" flex-gt-sm="66" layout-xs="row" class="widget margin-4"  style="background-color:#5dd27c;" layout="column">
		<div flex class="card-margin-4" layout="row">
	...
	<div ui-sref="home1.rounds_calls" flex="10" flex-xs="100" flex-gt-sm="66" layout-xs="row" class="widget margin-4" style="background-color:#c62828;" layout="column">
		<div flex class="card-margin-4" layout="row">
	...
	<div ui-sref="home1.transfer_calls" flex="10" flex-xs="100" flex-gt-sm="66" layout-xs="row" class="widget margin-4" style="background-color:#2b247d;" layout="column">
		<div flex class="card-margin-4" layout="row">
	...
	<div ui-sref="home1.condemnation_calls" flex="10" flex-xs="100" flex-gt-sm="66" layout-xs="row" class="widget margin-4" style="background-color:#ff1979;" layout="column">
		<div flex class="card-margin-4" layout="row">
	...
	<div ui-sref="home1.{{user_role_code | lowercase}}_completed_calls" flex="10" flex-xs="100" flex-gt-sm="66" layout-xs="row" class="widget margin-4"  style="background-color:#6c1f7d;" layout="column">
		<div flex class="card-margin-4" layout="row">
