...
<md-content class="mylayout-padding" md-theme="inputs" layout-wrap>
    <div layout="column">
        <h3 class="heading-stylerespond">Add {{add_device.INDENT_TYPE}} to Stock</h3>
    ...
    <form name="AddDevice" method="POST">
        <h5 flex class="sub_heading-style-respond">{{add_device.INDENT_TYPE}} Basic Details:</h5>
	<div layout-gt-sm="row" layout-xs="column" layout-gt-xs="column" layout="row" layout-wrap>
      ...
      <md-input-container class="md-block" flex-gt-sm flex="20">
        <label>{{add_device.INDENT_TYPE}} Name</label>
    ...
    <div flex="5" hide-xs hide-sm><!-- Space --></div>
        <md-input-container ng-if="add_device.INDENT_TYPE==indent_requests[0]" class="md-block" flex-gt-sm flex="20">
    ...
    <div flex="5" ng-if="add_device.INDENT_TYPE==indent_requests[0]" hide-xs hide-sm><!-- Space --></div>
	...
	<md-input-container class="md-block" flex-gt-sm flex="20">
    <label>{{add_device.INDENT_TYPE}} Cost</label>
...
<div layout-gt-sm="row" layout-xs="column" layout-gt-xs="column" layout="row">-->
    ...
    <div flex="5" ng-if="add_device.INDENT_TYPE==indent_requests[0]" hide-xs hide-sm><!-- Space --></div>
        <md-input-container ng-if="add_device.INDENT_TYPE==indent_requests[2] || add_device.INDENT_TYPE==indent_requests[0]" class="md-block" flex-gt-sm flex="20">
            <label>Accessories</label>
            <input type="text" ng-required="add_device.INDENT_TYPE==indent_requests[2]" ng-model="add_device.accessories" name="accessories" aria-label="accessories"/>
        </md-input-container>
    <div flex="5" ng-if="add_device.INDENT_TYPE==indent_requests[2] || add_device.INDENT_TYPE==indent_requests[0]" hide-xs hide-sm><!-- Space --></div>

    <md-input-container ng-if="add_device.INDENT_TYPE==indent_requests[1] || add_device.INDENT_TYPE==indent_requests[0]" class="md-block" flex-gt-sm flex="20">
        <label>Critical Spares</label>
        <input type="text" ng-required="add_device.INDENT_TYPE==indent_requests[1]" ng-model="add_device.critical_spares" name="critical_spares" aria-label="critical_spares"/>
    </md-input-container>
    <!--</div>

    <div layout-gt-sm="row" layout-xs="column" layout-gt-xs="column" layout="row">-->
        <div flex="5" ng-if="add_device.INDENT_TYPE==indent_requests[1] || add_device.INDENT_TYPE==indent_requests[0]" hide-xs hide-sm><!-- Space --></div>
        <md-input-container ng-if="add_device.INDENT_TYPE==indent_requests[0]" flex="20">
        ...
        <md-input-container class="md-block" flex-gt-sm flex="20">
            ...
            <md-select md-on-close="clearSearchTerm()" data-md-container-class="selectdemoSelectHeader" ng-model="add_device.distributor" name="distributor" ng-required="add_device.INDENT_TYPE==indent_requests[0]" aria-label="distributor">
                <md-select-header class="demo-select-header">
    ...
    <div layout-gt-sm="row" layout-xs="column" layout-gt-xs="column" layout="row">-->
        <div flex="5" ng-if="add_device.INDENT_TYPE==indent_requests[0]" hide-xs hide-sm><!-- Space --></div>
            <mdp-date-picker ng-if="add_device.INDENT_TYPE==indent_requests[0]" md-required="true"  mdp-placeholder="Date of Install *" ng-change="setPmsQcDate($event,add_device.date_of_install)" name="date_of_install" required class="md-block" flex-gt-sm flex="20" mdp-format="DD-MM-YYYY" ng-model="add_device.date_of_install">
            </mdp-date-picker>
            <div flex="5" ng-if="add_device.INDENT_TYPE==indent_requests[0]" hide-xs hide-sm><!-- Space --></div>
            <md-input-container class="md-block" flex-gt-sm flex="20">
                <label>Manufacture Date(MM-YYYY)</label>
                <input required type="text" ng-pattern="/^([0-9])-([0-9]{4})$/"  ng-model="add_device.manufacture_date" name="manufacture_date" aria-label="manufacture_date"/>
	...
	<h5 class="sub_heading-style-respond">{{add_device.INDENT_TYPE}} Purchase Details:</h5>
	<div layout-gt-sm="row" layout-xs="column" layout-gt-xs="column" layout="row">
	<md-input-container class="md-block"  flex-gt-sm flex="20">
    <label>PO NO</label>
...
<!--    <input type="submit" class="md-button md-raised md-accent" layout-align="center center" ng-disabled="AddDevice.$invalid" ng-click="SaveDevice(add_device,'save_device')" aria-label="button" value="Save">-->
    <input type="submit" class="md-button md-raised md-accent" layout-align="center center" ng-click="saveStock(add_device)"  aria-label="buttonsd" value="Save">
        <md-button class="md-button md-raised md-accent" layout-align="center center" ng-click="switchState('home.indent_equipment')">Cancel</md-button>
    </center>
</div>
	</form>
	</div>
