(function(window, angular, undefined) {
	...
	.provider('ssSideNavSections', function SSSideNavSectionsProvider()
    {
        ...
        this.$get = [function ssSideNavSectionsFactory($http)
        {
    ...
    .factory('ssSideNav', [
        ...
        function(
            ...
            var self,sections = angular.fromJson(window.localStorage.getItem("user_menu"));
    ...
    .run(['$templateCache', function($templateCache) {
        ...
        $templateCache.put('views/ss/menu-sidenav.tmpl.html',
            '<ul class="menu">' +
            '    <li ss-style-color="{\'border-bottom-color\': \'primary.500\'}" ng-repeat="section in menu.sections" ng-if="!section.hidden">' +
